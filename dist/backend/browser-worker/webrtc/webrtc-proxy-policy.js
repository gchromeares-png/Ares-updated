...
exports.installWebRtcProxyPolicy = exports.WEBRTC_PROXY_INIT_SCRIPT = void 0;
/**
 ...
 */
exports.WEBRTC_PROXY_INIT_SCRIPT = String.raw `(() => {
...
async function installWebRtcProxyPolicy(context) {
    await context.addInitScript({ content: exports.WEBRTC_PROXY_INIT_SCRIPT });
}
exports.installWebRtcProxyPolicy = installWebRtcProxyPolicy;
//# sourceMappingURL=webrtc-proxy-policy.js.map